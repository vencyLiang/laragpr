...
<body >
    ...
    <div class="t_item" id="rankTree">
        <div class="t_item_ser"> <input type="text" name="" id=""> <img src="{{ asset('img/ser.png') }}"> </div>
        <div class="_team ">
...
<script>
    function getAvatar(user){
        ...
        if(typeof user === 'undefined'){
            return "{{ asset('storage/avatar/unknown.png')}}"
        }
    ...
    let avatar = getAvatar(@json($user->first(['id','name','avatar'])->toArray()));
            ...
            getSonInfo:function (user,type='avatar') {
                if(type === 'avatar') {
                    ...
                    if(typeof user === 'undefined'  ||  typeof user.id === 'undefined'){
                        ...
                        return 'http://' + "{{ $_SERVER['HTTP_HOST'] }}"+ '/rank/'+ user.id;
                    }
                }else if(type === 'name'){
